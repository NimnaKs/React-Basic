...
import { faHome, faExchangeAlt, faFileInvoice, faUser, faCog } from '@fortawesome/free-solid-svg-icons'
            ...
            <div className="container mx-auto">
                <nav className="navigation flex justify-center items-center py-4">
                    <ul className="flex space-x-8">
                        ...
                        <li className="flex items-center hover:text-gray-300">
                            <NavLink to="/profile/user"> <FontAwesomeIcon icon={faUser} className="mr-2" /> Profile </NavLink>
                        </li>
                        <li className="flex items-center hover:text-gray-300">
